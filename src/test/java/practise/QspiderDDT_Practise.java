...
public class QspiderDDT_Practise
{
public static void main(String[] args) throws IOException 
	{
//Read Common Data from Property file
			FileInputStream fis = new FileInputStream(".\\src\\test\\resources\\Commonfile");
			...
			FileInputStream fise = new FileInputStream(".\\src\\test\\resources\\Resourcedata.xlsx");
